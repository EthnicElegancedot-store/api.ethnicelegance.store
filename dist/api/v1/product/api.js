...
router.get("/filter", asyncHandler(async (req, res) => {
    const { page, limit, category, subCategory, design, priceMin, priceMax, rating, searchQuery, } = req.query;
...
router.get("/:productId", asyncHandler(async (req, res) => {
    ...
    return response.success(res, "Product is successfully retrieved", 200, formattedProduct);
}));
